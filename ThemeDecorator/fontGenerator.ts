/*
 * This module loads Limestone's locale specific fonts.
 *
 * _This is not intended to be directly included by external developers._ The purpose of this is to
 * override the existing "Limestone" font family with a new typeface, conditionally when the system
 * locale matches the corresponding locale for the font (defined in this component's code).
 *
 */
import {addLocalizedFont, generateFontRules, generateFontOverrideRules} from '@enact/ui/internal/localized-fonts';

const fontName = 'Limestone';
...
// 	}
// };
const fonts: Record<string, {regular: string | string[]}> = {
	'bn': {
...
export {
	generateFontRules as fontGenerator,
	generateFontOverrideRules as fontOverrideGenerator,
	generateFontRules
};
