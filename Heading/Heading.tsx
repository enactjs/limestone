...
const HeadingBase = kind({
	...
	propTypes: /** @lends limestone/Heading.HeadingBase.prototype */ {
		 ...
		 * @public
		 */
		size: PropTypes.oneOf(['large', 'medium', 'small', 'tiny', 'title', 'subtitle']) as PropTypes.Validator<'large' | 'medium' | 'small' | 'tiny' | 'title' | 'subtitle' | undefined>,
		 ...
		 * @public
		 */
		spacing: PropTypes.oneOf(['auto', 'large', 'medium', 'small', 'none']) as PropTypes.Validator<'auto' | 'large' | 'medium' | 'small' | 'none' | undefined>
	},
	...
	render: ({css, ...rest}) => {
		...
		return UiHeadingBase.inline!({css, ...rest}, void 0 as any);
	}
});
