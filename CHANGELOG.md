...
- `limestone/Inputfield` props `caretToEndOnFocus` to move caret to the end of the input field on input activation via 5-way
- `limestone/Inputfield` props `marqueeContent` to marquee text on focus
