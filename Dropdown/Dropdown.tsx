...
export interface DropdownBaseProps {
	'aria-label'?: string;
	children?: string[] | DropdownChildObject[];
 ...
 *
 * @class DropdownBase
 * @memberof limestone/Dropdown
 * @extends limestone/Button.Button
 * @extends limestone/ContextualPopupDecorator.ContextualPopupDecorator
 * @omit popupComponent
 * @ui
 * @public
 */
const DropdownBase = kind({
	...
	handlers: {
		onSelect: handle(
			forwardCustom('onSelect', (ev: any) => (ev)),
			forward('onClose')
		),
		onOpen: handle(
			forward('onClick'),
...
/**
 * Applies Limestone specific behaviors and functionality to
 * {@link limestone/Dropdown.DropdownBase|DropdownBase}.
 *
 * @hoc
 * @memberof limestone/Dropdown
 ...
 *
 * @name open
 * @memberof limestone/Dropdown.DropdownDecorator.prototype
 * @type {Boolean}
 * @default false
 * @public
 */
 ...
 * @class Dropdown
 * @memberof limestone/Dropdown
 * @extends limestone/Dropdown.DropdownBase
 * @ui
 * @public
 */
const Dropdown = DropdownDecorator(DropdownBase) as ComponentType<Omit<DropdownBaseProps, 'selected' | 'open'> & {defaultSelected?: number; open?: boolean; selected?: number}>;
