...
import type {ScrollInteractionParams, ScrollbarTrackProps} from './types';
...
/**
 * A Limestone-styled scrollbar track with limestone behavior
 *
...
const ScrollbarTrack = (props: ScrollbarTrackProps) => {
	...
	const consumeEventWithScroll = useCallback((scrollParam: ScrollInteractionParams, ev: any) => {
		ev.preventDefault();
	...
	const onKeyDown = useCallback((ev: any) => {
		if (SpotlightAccelerator.processKey(ev, nop)) {
			...
			const
				...
				scrollParam: ScrollInteractionParams = {
