...
const useOverscrollEffect = (_props: Record<string, any>, instances: Record<string, any>) => {
	...
	const applyOverscrollEffect = useCallback((orientation: string, edge: string, type: string, ratio: number) => {
	...
	useEffect(() => {
		function createOverscrollJob (orientation: string, edge: string) {
		...
		function stopOverscrollJob (orientation: string, edge: string) {
	...
	function clearOverscrollEffect (orientation: string, edge: string) {
	...
	function checkAndApplyOverscrollEffectByDirection (direction: string) {
		const
