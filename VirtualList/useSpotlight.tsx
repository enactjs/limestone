...
const useSpotlightConfig = (props: Record<string, any>, instances: Record<string, any>) => {
	// Hooks
	...
	useEffect(() => {
		...
		function lastFocusedRestore ({key}: {key: any}, all: any[]) {
...
const getNumberValue = (index: any) => {
...
const useSpotlightRestore = (props: Record<string, any>, instances: Record<string, any>, context: Record<string, any>) => {
	...
	function handlePlaceholderFocus (ev: any) {
	...
	function handleRestoreLastFocus ({firstIndex, lastIndex}: {firstIndex: number; lastIndex: number}) {
	...
	function updateStatesAndBounds ({dataSize, moreInfo, numOfItems}: {dataSize: number; moreInfo: any; numOfItems: number}) {
	...
	function setPreservedIndex (index: number, direction: string | null = null) {
