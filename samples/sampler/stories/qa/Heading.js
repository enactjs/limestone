...
export const WithBidirectionalText = (args) => {
	...
	return (
		<Scroller>
			...
			<Heading style={{width: '25rem'}} {...headingProps}>{inputPasswordFor}<bdi>{abcDevice}</bdi>, Please. long text long text long text long text long text long text long text long text long text</Heading>
