...
export const _PageViews = (args) => (
	<PageViews bannerMode={args['bannerMode']} fullContents={args['fullContents']} pageIndicatorPosition={args['pageIndicatorPosition']} pageIndicatorType={args['pageIndicatorType']}>
