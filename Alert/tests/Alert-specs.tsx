...
describe('FittedContentCell', () => {
	...
	test('should set content width based on measured rects', () => {
		window.Range.prototype.getClientRects = () => [{left: 10, right: 210}] as any;
		...
		const content = document.querySelector('[id$="_content"]') as HTMLElement;
		expect(content.style.width).toBe('200px');
	});

	test('should set content width spanning multiple rects', () => {
		window.Range.prototype.getClientRects = () => [{left: 10, right: 110}, {left: 10, right: 210}] as any;
	...
	test('should remeasure content width on window resize', () => {
		...
		window.Range.prototype.getClientRects = () => [{left: 10, right: 310}] as any;
