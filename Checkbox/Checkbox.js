 ...
 * part of {@link limestone/CheckboxItem|CheckboxItem}.
 *
 * Usage:
 * ```
 * <Checkbox selected />
...
const CheckboxBase = kind({
	...
	computed: {
		className: ({children, indeterminate, selected, standalone, styler}) => styler.append({checkmark: children === 'checkmark', selected, standalone, indeterminate}),
 ...
 * @class Checkbox
 * @memberof limestone/Checkbox
 * @extends limestone/Checkbox.CheckboxBase
 * @mixes limestone/Checkbox.CheckboxDecorator
 * @ui
 * @public
 */
