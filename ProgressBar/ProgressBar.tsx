...
const ProgressBarBase = kind({
	...
	propTypes: /** @lends limestone/ProgressBar.ProgressBarBase.prototype */ {
		 ...
		 * @public
		 */
		tooltip: PropTypes.oneOfType([PropTypes.bool, PropTypes.element, PropTypes.func]) as PropTypes.Validator<boolean | ComponentType<any> | ReactElement | undefined>
	},
 ...
 * @public
 */
const ProgressBar = ProgressBarDecorator(ProgressBarBase) as ComponentType<ProgressBarBaseProps>;
