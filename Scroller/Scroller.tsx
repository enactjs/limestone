 ...
 * @public
 */
let Scroller: ComponentType<ScrollerProps> = (props: ScrollerProps) => {
	const scrollerProps = setDefaultProps(props, scrollerDefaultProps) as ScrollerProps;
...
) as ComponentType<ScrollerProps>;

(Scroller as any).defaultPropValues = scrollerDefaultProps;
