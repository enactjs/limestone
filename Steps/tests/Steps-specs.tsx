...
describe('Steps Specs', () => {
	...
	test('should support custom `pastIcon`', () => {
		...
		const pastStepIcon = screen.getByRole('list').children.item(0)!.textContent!.codePointAt(0);
	...
	test('should support custom `currentIcon`', () => {
		...
		const currentStepIcon = screen.getByRole('list').children.item(1)!.textContent!.codePointAt(0);
	...
	test('should support custom `futureIcon`', () => {
		...
		const futureStepIcon = screen.getByRole('list').children.item(2)!.textContent!.codePointAt(0);
	...
	test('should support custom `skipIcon`', () => {
		...
		const skippedStepIcon = screen.getByRole('list').children.item(1)!.textContent!.codePointAt(0);
