 ...
 *
 * @module limestone/ContextualMenuDecorator
...
/**
 * Default config for {@link limestone/ContextualMenuDecorator.ContextualMenuDecorator}
 *
 * @type {Object}
 * @hocconfig
 * @memberof limestone/ContextualMenuDecorator.ContextualMenuDecorator
 */
const defaultConfig = {
	/**
	 ...
	 * @type {Boolean}
	 * @default false
	 * @memberof limestone/ContextualMenuDecorator.ContextualMenuDecorator.defaultConfig
	 * @public
	 */
	noSkin: false,
...
export interface ContextualMenuDecoratorBaseProps {
	direction?: ContextualMenuDirection;
	menuItems?: string[] | MenuItemObject[];
...
const ScrollingRepeater = ({className, ...rest}: Record<string, any>) => (
	<Scroller className={className}>
		<Repeater {...rest as any} />
	</Scroller>
);

const ContextualMenuDecoratorBase = hoc(defaultConfig, (config: typeof defaultConfig, Wrapped: ComponentType<any>) => {
	...
	const Component = (Skinnable as any)(
		(ContextualPopupDecorator as any)(
			{...config, noArrow: true},
			Wrapped
		)
	...
	return (kind as any)({
		...
		propTypes: /** @lends limestone/ContextualMenuDecorator.ContextualMenuDecorator.prototype */ {
			/**
 ...
 *
 * @hoc
 * @memberof limestone/ContextualMenuDecorator
