...
export interface PopupTabLayoutDimensions {
	tabs: {
		collapsed: number;
		normal: number;
	};
...
export interface PopupTabLayoutBaseProps {
	...
	dimensions?: PopupTabLayoutDimensions;
	index?: number;
	noAnimation?: boolean;
...
const PopupTabLayoutBase = kind({
	...
	_propTypes: {} as PopupTabLayoutBaseProps,
...
const OptimizedFocusDecorator = hoc({}, (config: Record<string, any>, Wrapped: ComponentType<any>) => {
	return class extends Component<OptimizedFocusDecoratorProps> {
		...
		constructor (props: OptimizedFocusDecoratorProps) {
			super(props);
			if (props.optimized) {
		...
		componentDidUpdate (prevProps: OptimizedFocusDecoratorProps) {
...
type PopupTabLayoutComponent = ComponentType<PopupTabLayoutBaseProps> & {Tab: typeof Tab};
 ...
 * @public
 */
const PopupTabLayout = PopupTabLayoutDecorator(PopupTabLayoutBase) as PopupTabLayoutComponent;
...
export interface TabPanelsBaseProps {
	rtl?: boolean;
	index?: number;
	[key: string]: any;
}
 ...
 * @public
 */
const TabPanelsBase = (props: TabPanelsBaseProps) => {
	...
	return <PanelsComponent noCloseButton {...rest} css={componentCss} {...handlers} />;
};
...
const TabPanel = (props: TabPanelProps) => {
	...
	return (
		<PanelComponent {...rest} css={componentCss} hideChildren={false} spotlightId={spotlightId} />
	);
};
