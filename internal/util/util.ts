 ...
 * @memberof limestone/internal/util
 * @private
 */
const extractVoiceProps = function (props: Record<string, any>): Record<string, any> {
 ...
 * @private
 */
const compareChildren = (a: any, b: any): boolean => {
 ...
 * @private
 */
const onlyUpdateForProps = (wrapped: ComponentType<any>, propKeys: any) => memo(wrapped, (prevProps: Record<string, any>, nextProps: Record<string, any>) => {
	const hasOwn = Object.prototype.hasOwnProperty;

	if (Array.isArray(propKeys)) {
		return propKeys.every((key: string) => hasOwn.call(prevProps, key) && hasOwn.call(nextProps, key) && Object.is(prevProps[key], nextProps[key]));
	}
