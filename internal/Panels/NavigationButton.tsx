...
const NavigationButton = kind({
	...
	render: ({component, focusEffectIconOnly, visible, ...rest}: Record<string, any>) => {

		if (isValidElement(component)) {
			extractAriaProps(rest);

			Object.keys((component.props as Record<string, any>)).forEach(key => {
				...
				if (typeof (component.props as Record<string, any>)[key] !== 'undefined') {
					rest[key] = (component.props as Record<string, any>)[key];
				}
			});
