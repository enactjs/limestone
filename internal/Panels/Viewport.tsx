...
const PanelsStateContext = createContext<Record<string, any>>({});
 ...
 * @private
 */
const ViewportBase = class extends Component<Record<string, any>, Record<string, any>> {
	static displayName = 'Viewport';

	static contextType = SharedState;

	static propTypes = /** @lends limestone/Panels.Viewport.prototype */ {
	...
	shouldComponentUpdate ({index}: Record<string, any>) {
	...
	mapChildren = (children: ReactNode, generateId: (...args: any[]) => any) => mapAndFilterChildren(children, (child: any, index: any) => {
	...
	getEnteringProp = (noAnimation: boolean) => noAnimation ? null : 'hideChildren';
