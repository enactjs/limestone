...
const any = (...handlers: Array<(...args: any[]) => any>) => (...args: any[]) => handlers.find(fn => fn(...args)) != null;
...
onWindowReady(() => {
	...
	document.addEventListener('keydown', handleGlobalKeyDownCapture as unknown as EventListener, {capture: true});
	document.addEventListener('keyup', handleGlobalKeyDownCapture as unknown as EventListener, {capture: true});
});
